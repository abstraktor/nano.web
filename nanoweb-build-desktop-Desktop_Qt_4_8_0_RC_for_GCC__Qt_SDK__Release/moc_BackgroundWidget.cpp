...
void ipn::BackgroundWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ipn::BackgroundWidget::staticMetaObjectExtraData = {
...
const QMetaObject ipn::BackgroundWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ipn__BackgroundWidget,
      qt_meta_data_ipn__BackgroundWidget, &staticMetaObjectExtraData }
};
