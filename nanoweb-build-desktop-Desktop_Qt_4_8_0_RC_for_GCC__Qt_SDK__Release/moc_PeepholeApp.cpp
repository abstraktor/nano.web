...
**
** Created: Wed Dec 21 20:00:36 2011
...
void ipn::PeepholeApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PeepholeApp *_t = static_cast<PeepholeApp *>(_o);
        switch (_id) {
        case 0: _t->moveContents((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ipn::PeepholeApp::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ipn::PeepholeApp::staticMetaObject = {
    { &App::staticMetaObject, qt_meta_stringdata_ipn__PeepholeApp,
      qt_meta_data_ipn__PeepholeApp, &staticMetaObjectExtraData }
};
