...
**
** Created: Wed Dec 21 20:00:53 2011
...
void ipn::PickerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PickerWidget *_t = static_cast<PickerWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ipn::PickerWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ipn::PickerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ipn__PickerWidget,
      qt_meta_data_ipn__PickerWidget, &staticMetaObjectExtraData }
};
