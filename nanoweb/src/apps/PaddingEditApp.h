#ifndef IPN_PaddingEditApp_H
#define IPN_PaddingEditApp_H
...
class PaddingEditApp : public App
{
	Q_OBJECT

public:
	PaddingEditApp(QWidget *parent = 0);
...
#endif /* end of include guard: IPN_PaddingEditApp_H */
